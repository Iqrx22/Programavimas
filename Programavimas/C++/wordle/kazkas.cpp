...
void ivestis(char rodykle[][50][2], int ilgis, int kuris_zodis, struct zodis_numeris a, bool rodyti_atsakyma, char raides[2][35]) {
    ...
    cout<<"Jums liko "<<spejimu_skaicius-kuris_zodis<<" spëjimai ið "<<spejimu_skaicius<<". Áveskite jûsø "<<kuris_zodis+1<<" spëjimø ið "<<ilgis<<" raidþiø áveskite \"Pasiduodu\", kad pasiduotute): ";
    cin>>spejimas;
