...
void isvesti_busena(char rodykle[][50][2], int ilgis, int kuris_zodis, struct zodis_numeris a, bool rodyti_atsakyma, char raides[2][35]) {
    ...
    system("CLS");
    /*if (rodyti_atsakyma) {
    cout<<"Žodþio numeris: "<<a.numeris<<". Atsakymas: "<<a.zodis<<"."<<endl;
    } */
...
void ivestis(char rodykle[][50][2], int ilgis, int kuris_zodis, struct zodis_numeris a, bool rodyti_atsakyma, char raides[2][35]) {
    ...
    cout<<"Jums liko "<<spejimu_skaicius-kuris_zodis<<" spėjimai iš "<<spejimu_skaicius<<". Įveskite jūsų "<<kuris_zodis+1<<" spėjimą iš "<<ilgis<<" raidžių. Įveskite \"Pasiduodu\", kad pasiduotute): ";
    cin>>spejimas;
